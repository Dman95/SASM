...
void
CodeEditor::lineNumberAreaMousePressEvent(QMouseEvent* event) {
	if (hasBreakpoints) {
...
void
CodeEditor::setBreakpointOnCurrentLine() {
	if (hasBreakpoints) {
...
void
CodeEditor::repaintLineNumberArea() {
	//repaint
...
void
CodeEditor::highlightDebugLine(int lineNumber) {
	if (debugMode) {
		QList<QTextEdit::ExtraSelection> extraSelections;
...
void
CodeEditor::updateDebugLine(int number) {
...
void
CodeEditor::setDebugMode(bool mode) {
	debugMode = mode;
}
...
void
CodeEditor::dragEnterEvent(QDragEnterEvent* event) {
	event->acceptProposedAction();
}

void
CodeEditor::dropEvent(QDropEvent* event) {
...
void
CodeEditor::shiftBreakpoints(int blockCount) {
	if (prevBlockCount == -1) {
...
bool
CodeEditor::isMacroOnCurrentDebugLine() {
