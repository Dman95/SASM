...
void
DebugAnyCommandWidget::showPreviousCommand() {
...
void
DebugAnyCommandWidget::showNextCommand() {
...
void
DebugAnyCommandWidget::keyPressEvent(QKeyEvent* event) {
...
void
DebugAnyCommandWidget::processCommand() {
