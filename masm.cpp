...
quint64
MASM::getMainOffset(QFile& lst, QString entryLabel) {
...
void
MASM::parseLstFile(QFile& lst, QVector<Assembler::LineNum>& lines, quint64 offset) {
	QTextStream lstStream(&lst);
...
void
MASM::putDebugString(CodeEditor*) {}

QString
MASM::getAssemblerOptions() {
	return "/nologo /Sn /Sa /c /coff /Fo$PROGRAM.OBJ$ /Fl$LSTOUTPUT$ $SOURCE$";
}

QString
MASM::getLinkerOptions() {
