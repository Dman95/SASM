...
quint64
NASM::getMainOffset(QFile& lst, QString entryLabel) {
...
void
NASM::parseLstFile(QFile& lst, QVector<Assembler::LineNum>& lines, quint64 offset) {
...
void
NASM::putDebugString(CodeEditor* code) {
