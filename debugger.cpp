...
void
Debugger::processMessage(QString output, QString error) {
...
void
Debugger::processAction(QString output, QString error) {
...
void
Debugger::doInput(QString command, DebugActionType actionType) {
	if (actionType != none)
...
void
Debugger::setWatchesCount(int count) {
	watchesCount = count;
}
...
void
Debugger::changeBreakpoint(quint64 lineNumber, bool isAdded) {
