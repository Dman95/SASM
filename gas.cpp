...
quint64
GAS::getMainOffset(QFile& lst, QString entryLabel) {
...
void
GAS::parseLstFile(QFile& lst, QVector<Assembler::LineNum>& lines, quint64 offset) {
...
void
GAS::putDebugString(CodeEditor* code) {
