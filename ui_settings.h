...
public:
    ...
    void setupUi(QWidget *SettingsWindow)
    {
        ...
        formLayout->setWidget(8, QFormLayout::LabelRole, disableLinkingLabel);
        ...
        formLayout->setWidget(8, QFormLayout::FieldRole, disableLinkingCheckbox);
        ...
        formLayout->setWidget(7, QFormLayout::LabelRole, assemblerWorkingDirectoryLabel);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, runInCurrentDirectoryCheckbox);
